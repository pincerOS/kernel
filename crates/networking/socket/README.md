here's an example of processing sockets
in my iface file


```rust
use crate::repr::Ipv4Packet;
use crate::iface::{ethernet, ipv4, tcp, udp, Interface};
use crate::socket::{RawSocket, RawType, SocketSet, TaggedSocket, TcpSocket, UdpSocket};
