...
pub use vmm::{create_user_region, init_physical_alloc, map_pa_to_va_kernel, map_pa_to_va_user, init_page_allocator, get_prev_user_translation_table_va, UserTranslationTable};
