...
impl Packet {
    ...
    // pub fn extract_tcp_flags_from_payload(&mut self) -> u8 {
    //     if self.payload.len() >= 14 {  // TCP flags at offset 13
    //         self.payload[13]
    //     } else {
    //         0
    //     }
    ...
    //         ((self.payload[9] as u32) << 16) |
    //         ((self.payload[10] as u32) << 8) |
    //         (self.payload[11] as u32)
    //     } else {
    //         0
    //     }
    // }
