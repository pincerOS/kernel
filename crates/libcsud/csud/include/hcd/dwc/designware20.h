...
extern volatile struct HostGlobalRegs {
	volatile struct HostGlobalRegsA {
		volatile enum {
			Clock30_60MHz,
			Clock48MHz,
			Clock6MHz
	...
	volatile struct HostGlobalRegsB {
	...
	volatile struct HostGlobalRegsC {
	...
	volatile struct HostGlobalRegsD {
		volatile unsigned SpaceAvailable : 16; // @0
		volatile unsigned QueueSpaceAvailable : 8; // @16
		volatile unsigned Terminate : 1; // @24
		volatile enum {
	...
	volatile struct HostChannel {
		...
		volatile u32 DmaAddress;  // +0x14 // FIX: was a pointer, must be u32
...
_Static_assert(sizeof(struct HostGlobalRegsA) == 0x4, "incorrect HostGlobalRegs size");
_Static_assert(sizeof(struct HostGlobalRegsB) == 0x4, "incorrect HostGlobalRegs size");
_Static_assert(sizeof(struct HostGlobalRegsC) == 0x4, "incorrect HostGlobalRegs size");
_Static_assert(sizeof(struct HostGlobalRegsD) == 0x4, "incorrect HostGlobalRegs size");
_Static_assert(sizeof(struct HostPort) == 0x4, "incorrect HostGlobalRegs size");
_Static_assert(sizeof(struct HostChannel) == 0x20, "incorrect HostGlobalRegs size");
_Static_assert(sizeof(struct HostChannel) == 0x20, "incorrect HostGlobalRegs size");

_Static_assert(sizeof(struct HostGlobalRegs) == 0x400, "incorrect HostGlobalRegs size");
